...
var $author$project$WSDecoder$PlayerObj = F2(
	function (playerid, speed) {
		return {playerid: playerid, speed: speed};
	});
var $author$project$WSDecoder$playerDecoder = A3(
	$NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'speed',
	$elm$json$Json$Decode$int,
	A3(
...
var $author$project$Main$subscriptions = function (_v0) {
	return $author$project$Main$messageReceiver($author$project$Main$decodeWS);
};
			...
			case 'PlayPause':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{draft: ''}),
					$author$project$Main$sendMessage('{ "jsonrpc": "2.0", "method": "Input.ExecuteAction", "params": { "action": "playpause" }, "id": 1 }'));
			case 'Skip':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{draft: ''}),
					$author$project$Main$sendMessage('{ "jsonrpc": "2.0", "method": "Input.ExecuteAction", "params": { "action": "skipnext" }, "id": 1 }'));
			default:
				var message = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
